...
local function getWiboxText()
	...
	local isCharging = assert(io.open("/sys/class/power_supply/BAT0/status", "r")):read():gsub("%s+", "") == "Charging"
	local batteryIcon
...
_G.batteryWidgetContainer.bgimage = "/home/jetblack/.config/awesome/icons/bg_blue.png"
