...
mykeyboardlayout.bgimage = "/home/jetblack/.config/awesome/icons/bg_blue.png"

local powerLauncher = require("widgets/power")
local memoryUsage = require("widgets/memoryUsage")
local batteryAndNotification = require("widgets/batteryAndNotification")
local clockAndCal = require("widgets/clockAndCal")
...
awful.screen.connect_for_each_screen(function(s)
	...
	mylayoutboxWithColor.bgimage = "/home/jetblack/.config/awesome/icons/bg_green3.png"
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "#90", function()
		awful.spawn.with_shell("feh --bg-fill -r -z ~/Pictures/Wallpaper/")
	end, { description = "change wallpaper by feh", group = "launcher" }),

	awful.key({ modkey }, "#91", function()
		awful.spawn.with_shell("feh --bg-fill -z ~/Pictures/Wallpaper/wallhaven-eyz56k.png")
	...
	awful.key({ modkey }, "r", function()
		awful.spawn.with_shell("/home/jetblack/.config/rofi/scripts/launcher_t1")
	end, { description = "run rofi application menu", group = "launcher" }),

	awful.key({ modkey }, "#49", function()
		awful.spawn.with_shell("/home/jetblack/.config/rofi/scripts/powermenu_t2")
	...
	awful.key({ modkey }, "p", function()
		xrandr.xrandr()
	end, { description = "switch monitor scheme", group = "screen" }),
	--]]
