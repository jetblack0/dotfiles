...
local function on_attach(bufnr)
  ...
  keymap("n", "W", function() nvimtree_api.tree.collapse_all({keep_buffers = false}) end, opts "Collapse tree")
  keymap("n", "w", function() nvimtree_api.tree.expand_all() end, opts "Expand tree")
