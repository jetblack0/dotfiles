...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "r", function()
		awful.spawn.with_shell("/home/jetblack/.config/rofi/launcher.sh 1 1 yousai Iosevka 14")
	end, { description = "run rofi application menu", group = "launcher" }),

	awful.key({ modkey }, "#49", function()
		awful.spawn.with_shell("/home/jetblack/.config/rofi/powermenu.sh 2 2 yousai JetBrains\\ Mono\\ Nerd\\ Font 12")
